...
<body>
    <div id='wrap'>
        ...
        <div id='container'>                
            ...
            <div id='side_menu'>
                    <div id='side_btn'><img src="/semiRecipe/img/home_open_btn.png"></div>
                    <div id='search_div'>
                        <label for ='search'><img src="/semiRecipe/img/home_search_img.PNG"></label><input type="text" name="search">
                    </div>
                    <div id='ingredients_div'>
                        ...
                        <div id='ing_maker'>
                        	<c:forEach items="${requestScope.aList }" var="dto">
                        		<div class='ingredients ${dto.ty_nm}' id='${dto.irdnt_nm}' >${dto.irdnt_nm}</div>
                        	</c:forEach>
                        </div>
                    </div>
                </div>  
