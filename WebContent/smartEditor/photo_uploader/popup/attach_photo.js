...
function html5Upload() {
	...
	sUploadURL = '/semiRecipe/recipe/imageUpload'; // upload
...
function callFileUploader() {
	oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"), {
		...
		// //사진을 업로드할 URL 경로
		sUrl : '/semiRecipe/smartEditor/photo_uploader/upload.jsp',
		sCallBack : '/semiRecipe/smartEditor/photo_uploader/callback.html', //절대경로
