...
$(document).ready(function() {
   ...
   $('.icon-search').on('click', function() {
	   $('#searchform').attr('action', 'recipe/review');
	   $('#searchform').submit();
   });
   
   $('[name=searchWord]').val('${dto.searchWord}');
   if('${dto.searchKey}'=='null'){
	   $('[name=searchWord]').val('');
   }
    switch('${dto.searchKey}'){
	case 'all'	
	: $('[value=all]').prop('selected', 'selected'); 
	$('[name=searchWord]').val(''); break;
	case 'subject'	
	: $('[value=review_subject]').prop('selected', 'selected'); break;
	case 'writer'	
	: $('[value=review_content]').prop('selected', 'selected'); break;
	case 'content'	
	: $('[value=user_nickname]').prop('selected', 'selected'); break;
...
<body>
   ...
   <div id="wrapper">
      ...
      <section id="main">
         ...
         <div id="searchLine">
            <select name="searchKey" id="searchDrop">
