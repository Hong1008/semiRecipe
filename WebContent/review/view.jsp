	...
	<div id="view_post">
		...
		<table class="viewerTableSecond">
			...
			<tr id="review_title_second">
				...
				<td id="recipeID" width="300px"><a href="http://localhost:8090/semiRecipe/recipe/showRecipe?recipe_id=${viewer.recipe_id}" onclick="window.open(this.href, '_blank', 'width=body.50%, height=this.100%');return false;" >${viewer.recipe_nm_ko}</td>
